...
/*	if (CMFCToolBar::GetUserImages() == NULL)
    ...
    AddTitleButton(&rcNCButton,pImage,3,10,_T("标题按钮"));

	rcNCButton.OffsetRect(80,0);
	AddTitleButton(&rcNCButton,pImage,3,11,_T("标题按钮2"));

	rcNCButton.OffsetRect(80,0);
	AddTitleButton(&rcNCButton,pImage,3,12,_T("标题按钮3"));

	rcNCButton.OffsetRect(80,0);
	AddTitleButton(&rcNCButton,pImage,3,13,_T("关于"));
...
BOOL CMainFrame::OnCommand(WPARAM wParam, LPARAM lParam)
{
	...
	return CSkinFrameWnd::OnCommand(wParam, lParam);
}
